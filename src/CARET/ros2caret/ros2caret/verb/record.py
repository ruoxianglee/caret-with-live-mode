...
class RecordVerb(VerbExtension):
    ...
    def add_arguments(self, parser, cli_name):
        ...
        parser.add_argument(
            '-m', '--lttng-live-mode', dest='lttng_live_mode', action='store_true',
            help='the trace mode of the LTTng tracing session (default: non-live mode)')
    ...
    def main(self, *, args):
        ...
        init_args['lttng_live_mode'] = args.lttng_live_mode
